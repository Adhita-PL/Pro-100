...
print('Hello ', Name, '! Welcome to this Atm .') 
...
class ATM(object):
    ...
    transaction=str(input('If you want to withdraw some money press 1. \nIf you want to deposit some money press 2. \nIf you want to know how much money you have press 3. -> '))
    ...
    if transaction=='1':
        ...
        print('There is no activity for the number '+ transaction + "Enter a valid number") 